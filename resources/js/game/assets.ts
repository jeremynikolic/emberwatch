...
export const ASSET_FILES: Record<AssetKey, string> = {
  watchfire: '/game-assets/watchfire-2x.png',
  boltThrower: '/game-assets/bolt-thrower-2x.png',
  frostCondenser: '/game-assets/frost-condenser-2x.png',
  bombard: '/game-assets/bombard-2x.png',
  rootCrawler: '/game-assets/root-crawler-2x.png',
};
